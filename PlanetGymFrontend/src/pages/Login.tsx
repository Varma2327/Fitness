...
<button disabled={loading} className="w-full rounded-xl px-3 py-2 bg-violet-700 text-white hover:bg-violet-600 disabled:opacity-50">{loading ? 'Signing in…' : 'Sign in'}</button>
</form>
</div>
)
}